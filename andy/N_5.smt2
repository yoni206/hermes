...
;edge E_22 from __ to N_5.kb
(assert (and (and (and (|SWB.MC_SW.a1| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| |SWB.inst|)) (|SWB.RadioDriver.g1| (|SWB.MC_SW_dot_Impl.RADIO| |SWB.inst|))) (|SWB.FlightPlanner.g1| (|SWB.MC_SW_dot_Impl.FPLN| |SWB.inst|))) (|SWB.UARTDriver.g1| (|SWB.MC_SW_dot_Impl.UART| |SWB.inst|))))

;edge E_23 from __ to N_5.g
(assert (not (|SWB.WaypointManager.a1| (|SWB.MC_SW_dot_Impl.WPM| |SWB.inst|))))
