...
;E_2 from __ to N_1.kb
(assert (and (and (and (and (|SWB.MC_SW.a1| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| |SWB.inst|)) (|SWB.RadioDriver.g1| (|SWB.MC_SW_dot_Impl.RADIO| |SWB.inst|))) (|SWB.FlightPlanner.g1| (|SWB.MC_SW_dot_Impl.FPLN| |SWB.inst|))) (|SWB.WaypointManager.g1| (|SWB.MC_SW_dot_Impl.WPM| |SWB.inst|))) (|SWB.UARTDriver.g1| (|SWB.MC_SW_dot_Impl.UART| |SWB.inst|))) )

;E_3 from __ to N_1.g
(assert (not (|SWB.MC_SW.g1| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| |SWB.inst|))))
(check-sat)
