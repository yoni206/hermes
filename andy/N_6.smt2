...
;edge N_27 from __ to N_6.kb
(assert  (and (and (and (|SWB.MC_SW.a1| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| |SWB.inst|)) (|SWB.RadioDriver.g1| (|SWB.MC_SW_dot_Impl.RADIO| |SWB.inst|))) (|SWB.FlightPlanner.g1| (|SWB.MC_SW_dot_Impl.FPLN| |SWB.inst|))) (|SWB.WaypointManager.g1| (|SWB.MC_SW_dot_Impl.WPM| |SWB.inst|))) )

;edge N_28 from __ to N_6.g
(assert (not  (|SWB.UARTDriver.a1| (|SWB.MC_SW_dot_Impl.UART| |SWB.inst|))))
