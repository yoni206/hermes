...
g_result = None
solvers_dir = "/home/yoniz/git/hermes/dispatcher/solvers"


cvc4_binary = solvers_dir + "/cvc4"
yices_binary = solvers_dir + "/yices"
boolector_binary = solvers_dir + "/btor"
verit_binary = solvers_dir + "/verit"
spasssatt_binary = solvers_dir + "/spasssatt"
mathsat_binary = solvers_dir + "/mathsat"
CONFIGS = [
  [cvc4_binary],
  [yices_binary],
  [boolector_binary],
