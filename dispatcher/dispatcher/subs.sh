...
sed -i "s|./SPASS-SATT|$SOLVERS_DIR/SPASS-SATT/bin/./SPASS-SATT|" $SOLVERS_DIR/SPASS-SATT/bin/starexec_run_default
sed -i "s|./yices2|$SOLVERS_DIR/Yices_2.6.2/bin/./yices2|" $SOLVERS_DIR/Yices_2.6.2/bin/starexec_run_default
sed -i "s|./mathsat|$SOLVERS_DIR/mathsat-20190601/bin/./mathsat|" $SOLVERS_DIR/mathsat-20190601/bin/starexec_run_default.sh
