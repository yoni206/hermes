...
#ifdef HW_VERSION
#define LAsigned_xx_set_si(a, b) { a = b; }
#else
...
/**
   ...
   \param[in] rational2 a second rational value
   \remark normalizes */
void LArational_xx_mult(TLArational_xx rational1, const TLArational_xx rational2);
...
void LArational_xx_mult_to_signed_aux(TLAsigned_xx *Pasigned, TLArational_xx rational);
#else
/**
   \author Pascal Fontaine
   \brief multiplies asigned by rational
   ...
   \remark stores the result in asigned
   \remark the result should be integer */
void LArational_xx_mult_to_signed(TLAsigned_xx asigned, TLArational_xx rational);
#endif
...
void LAdelta_xx_get_rat(TLAdelta_xx *src, TLAsigned_xx *Pnum, TLAsigned_xx *Pden);
#define LAdelta_xx_get_rat(src, num, den)    \
  {                                          \
...
/**
   ...
   \param[in] delta1 value
   \param[in] a value */
void LAdelta_xx_addmult(TLAdelta_xx * delta0, TLAdelta_xx * delta1, TLAsigned_xx a);
...
/**
   ...
   \param[in] delta1 value
   \param[in] delta2 value */
void LAdelta_xx_minus(TLAdelta_xx * delta0, TLAdelta_xx * delta1, TLAdelta_xx * delta2);
