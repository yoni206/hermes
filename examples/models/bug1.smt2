	...
	(and
		...
		(exists ((x Int)(y Int)) 
			(and
				...
				(and   
					(or 
						(= (utrc.test1.S1.i1 x2) (/ x (utrc.test1.S1.n x2)))
						(= (utrc.test1.S1.i1 x2) (* (- 1) (/ x (utrc.test1.S1.n x2))))
					)
					(or 
						(= (utrc.test1.S1.i2 x2) (/ y (utrc.test1.S1.n x2)))
						(= (utrc.test1.S1.i2 x2) (* (- 1) (/ y (utrc.test1.S1.n x2))))
					)
				)
			)
		)
	...
	(= (utrc.test1.S2.o1 x1) 
		(+
			(* 
				(utrc.test1.S2.i1 x1)
				(^ 2 0.5)
				(sin (utrc.test1.S2.alpha x1))
			)
			(*
				(utrc.test1.S2.i2 x1)
				(^ 2 0.5)
				(cos (utrc.test1.S2.alpha x1))
			)
		)	
	) 
)
