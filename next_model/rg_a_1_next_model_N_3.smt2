...
(assert (and (and (and (|SWIMLAnnex.MC_SW.a1| (|SWIMLAnnex.MC_SW_dot_Impl.extends_SWIMLAnnex.MC_SW| |SWIMLAnnex.inst|)) 
...
;N_3
;goal
(assert (not (and (|SWIMLAnnex.FlightPlanner.a1| (|SWIMLAnnex.MC_SW_dot_Impl.FPLN| |SWIMLAnnex.inst|)) 
