...
(declare-fun |iml.ports.FlowPoint.upperBound| (|iml.ports.FlowPoint|) |Int|)
(declare-fun |iml.ports.FlowPoint.lowerBound| (|iml.ports.FlowPoint|) |Int|)
...
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.UARTDriver.position_status_out| (|SWB.MC_SW_dot_Impl.UART| __inst__)) (|SWB.RadioDriver.send_status_in| (|SWB.MC_SW_dot_Impl.RADIO| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.FlightPlanner.flight_plan| (|SWB.MC_SW_dot_Impl.FPLN| __inst__)) (|SWB.WaypointManager.flight_plan| (|SWB.MC_SW_dot_Impl.WPM| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.MC_SW.position_status| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| __inst__)) (|SWB.UARTDriver.position_status_in| (|SWB.MC_SW_dot_Impl.UART| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.WaypointManager.waypoint| (|SWB.MC_SW_dot_Impl.WPM| __inst__)) (|SWB.UARTDriver.waypoint_in| (|SWB.MC_SW_dot_Impl.UART| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.UARTDriver.waypoint_out| (|SWB.MC_SW_dot_Impl.UART| __inst__)) (|SWB.MC_SW.waypoint| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.UARTDriver.position_status_out| (|SWB.MC_SW_dot_Impl.UART| __inst__)) (|SWB.WaypointManager.position_status| (|SWB.MC_SW_dot_Impl.WPM| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.UARTDriver.position_status_out| (|SWB.MC_SW_dot_Impl.UART| __inst__)) (|SWB.FlightPlanner.position_status| (|SWB.MC_SW_dot_Impl.FPLN| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.MC_SW.recv_map| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| __inst__)) (|SWB.RadioDriver.recv_map_in| (|SWB.MC_SW_dot_Impl.RADIO| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.RadioDriver.send_status_out| (|SWB.MC_SW_dot_Impl.RADIO| __inst__)) (|SWB.MC_SW.send_status| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| __inst__)))))
(assert (exists ((__inst__ |SWB.MC_SW_dot_Impl|)) (= (|SWB.RadioDriver.recv_map_out| (|SWB.MC_SW_dot_Impl.RADIO| __inst__)) (|SWB.FlightPlanner.recv_map| (|SWB.MC_SW_dot_Impl.FPLN| __inst__)))))
(assert (exists ((__inst__ |SWB.FlightPlanner|)) (= (|SWB.FlightPlanner.g1| __inst__) (|SWB.good_mission| (|__unnamed__.iml.ports.DataPort<SWB.Mission_dot_Impl>.data| (|SWB.FlightPlanner.flight_plan| __inst__))))))
(assert (exists ((__inst__ |SWB.FlightPlanner|)) (= (|SWB.FlightPlanner.a1| __inst__) (= (|SWB.Command_dot_Impl.HMAC| (|__unnamed__.iml.ports.EventDataPort<SWB.Command_dot_Impl>.data| (|SWB.FlightPlanner.recv_map| __inst__))) true))))
(assert (exists ((__inst__ |SWB.FlightPlanner|)) (= (|SWB.FlightPlanner.a2| __inst__) (|SWB.good_gs_command| (|__unnamed__.iml.ports.EventDataPort<SWB.Command_dot_Impl>.data| (|SWB.FlightPlanner.recv_map| __inst__))))))
(assert (exists ((__inst__ |SWB.WaypointManager|)) (= (|SWB.WaypointManager.g1| __inst__) (|SWB.good_mission_window| (|__unnamed__.iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>.data| (|SWB.WaypointManager.waypoint| __inst__))))))
(assert (exists ((__inst__ |SWB.WaypointManager|)) (= (|SWB.WaypointManager.a1| __inst__) (|SWB.good_mission| (|__unnamed__.iml.ports.DataPort<SWB.Mission_dot_Impl>.data| (|SWB.WaypointManager.flight_plan| __inst__))))))
(assert (exists ((__inst__ |SWB.MC_SW|)) (= (|SWB.MC_SW.g1| __inst__) (= (|SWB.MissionWindow_dot_Impl.crc| (|__unnamed__.iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>.data| (|SWB.MC_SW.waypoint| __inst__))) true))))
(assert (exists ((__inst__ |SWB.MC_SW|)) (= (|SWB.MC_SW.a1| __inst__) (= (|SWB.Command_dot_Impl.HMAC| (|__unnamed__.iml.ports.EventDataPort<SWB.Command_dot_Impl>.data| (|SWB.MC_SW.recv_map| __inst__))) true))))
(assert (exists ((__inst__ |__unnamed__.iml.connectivity.Connector<iml.ports.DataPort<SWB.Mission_dot_Impl>>|)) (= (|__unnamed__.iml.connectivity.Connector<iml.ports.DataPort<SWB.Mission_dot_Impl>>.source| __inst__) (|__unnamed__.iml.connectivity.Connector<iml.ports.DataPort<SWB.Mission_dot_Impl>>.target| __inst__))))
(assert (exists ((__inst__ |__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>>|)) (= (|__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>>.source| __inst__) (|__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>>.target| __inst__))))
(assert (exists ((__inst__ |__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.Coordinate_dot_Impl>>|)) (= (|__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.Coordinate_dot_Impl>>.source| __inst__) (|__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.Coordinate_dot_Impl>>.target| __inst__))))
(assert (exists ((__inst__ |__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.Command_dot_Impl>>|)) (= (|__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.Command_dot_Impl>>.source| __inst__) (|__unnamed__.iml.connectivity.Connector<iml.ports.EventDataPort<SWB.Command_dot_Impl>>.target| __inst__))))
(assert (exists ((__inst__ |SWB.UARTDriver|)) (= (|SWB.UARTDriver.a1| __inst__) (|SWB.good_mission_window| (|__unnamed__.iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>.data| (|SWB.UARTDriver.waypoint_in| __inst__))))))
(assert (exists ((__inst__ |SWB.UARTDriver|)) (= (|SWB.UARTDriver.g1| __inst__) (= (|SWB.MissionWindow_dot_Impl.crc| (|__unnamed__.iml.ports.EventDataPort<SWB.MissionWindow_dot_Impl>.data| (|SWB.UARTDriver.waypoint_out| __inst__))) true))))
(assert (exists ((map |SWB.Map_dot_Impl|)) (= (|SWB.good_map| map) (and (and (and (|SWB.good_coordinate| (|SWB.Map_dot_Impl.wp1| map)) (|SWB.good_coordinate| (|SWB.Map_dot_Impl.wp2| map))) (|SWB.good_coordinate| (|SWB.Map_dot_Impl.wp3| map))) (|SWB.good_coordinate| (|SWB.Map_dot_Impl.wp4| map))))))
(assert (exists ((cmd |SWB.Command_dot_Impl|)) (= (|SWB.good_gs_command| cmd) (and (|SWB.good_map| (|SWB.Command_dot_Impl.Map| cmd)) (|SWB.good_HMAC| (|SWB.Command_dot_Impl.HMAC| cmd))))))
(assert (exists ((mission |SWB.Mission_dot_Impl|)) (= (|SWB.good_mission| mission) (and (and (and (and (and (and (and (and (and (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp1| mission)) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp2| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp3| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp4| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp5| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp6| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp7| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp8| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp9| mission))) (|SWB.good_coordinate| (|SWB.Mission_dot_Impl.wp10| mission))))))
(assert (exists ((coord |SWB.Coordinate_dot_Impl|)) (= (|SWB.good_coordinate| coord) (and (and (and (and (and (>= (|SWB.Coordinate_dot_Impl.lat| coord) (- 90)) (<= (|SWB.Coordinate_dot_Impl.lat| coord) 90)) (>= (|SWB.Coordinate_dot_Impl.long| coord) (- 180))) (<= (|SWB.Coordinate_dot_Impl.long| coord) 180)) (>= (|SWB.Coordinate_dot_Impl.alt| coord) 0)) (<= (|SWB.Coordinate_dot_Impl.alt| coord) 15000)))))
(assert (exists ((hmac |Bool|)) (= (|SWB.good_HMAC| hmac) (or (= hmac true) (= hmac false)))))
(assert (exists ((win |SWB.MissionWindow_dot_Impl|)) (= (|SWB.good_mission_window| win) (and (and (and (|SWB.good_coordinate| (|SWB.MissionWindow_dot_Impl.wp1| win)) (|SWB.good_coordinate| (|SWB.MissionWindow_dot_Impl.wp2| win))) (|SWB.good_coordinate| (|SWB.MissionWindow_dot_Impl.wp3| win))) (|SWB.good_coordinate| (|SWB.MissionWindow_dot_Impl.wp4| win))))))
(assert (exists ((__inst__ |SWB.RadioDriver|)) (= (|SWB.RadioDriver.a1| __inst__) (= (|SWB.Command_dot_Impl.HMAC| (|__unnamed__.iml.ports.EventDataPort<SWB.Command_dot_Impl>.data| (|SWB.RadioDriver.recv_map_in| __inst__))) true))))
(assert (exists ((__inst__ |SWB.RadioDriver|)) (= (|SWB.RadioDriver.g1| __inst__) (= (|SWB.Command_dot_Impl.HMAC| (|__unnamed__.iml.ports.EventDataPort<SWB.Command_dot_Impl>.data| (|SWB.RadioDriver.recv_map_out| __inst__))) true))))

;knowledge base
( assert (and (and (and (|SWB.MC_SW.a1| (|SWB.MC_SW_dot_Impl.__base_SWB.MC_SW| |SWB.inst|)) (|SWB.FlightPlanner.g1| (|SWB.MC_SW_dot_Impl.FPLN| |SWB.inst|))) (|SWB.WaypointManager.g1| (|SWB.MC_SW_dot_Impl.WPM| |SWB.inst|))) (|SWB.UARTDriver.g1| (|SWB.MC_SW_dot_Impl.UART| |SWB.inst|))) )

;goal
( assert (|SWB.RadioDriver.a1| (|SWB.MC_SW_dot_Impl.RADIO| |SWB.inst|)) )
(check-sat)
(get-model)
(check-sat)
(get-model)
